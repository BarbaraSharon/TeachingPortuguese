...
export const HeroBlock = ({content, design, _id, icon_svg, secondary_icon_svg, media_image, media_image_dark, _hasStaticHeroTitle = false}) => {
  ...
  const TitleTag = _hasStaticHeroTitle ? "div" : "h1";
