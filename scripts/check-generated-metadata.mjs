...
assert.equal(countType('Article'), 66, 'Expected sixty-six rendered Article nodes.');
...
assert.equal(countType('WebPage'), 57, 'Expected fifty-seven rendered answer WebPage nodes.');
